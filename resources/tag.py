...
class LinkTagItem(MethodView):
    ...
    def post(self,item_id,tag_id):
        ...
        try:
            ...
            abort(500, messsge="An error oocured while inserting tag")
...
class Tag(MethodView):
    ...
    @blp.alt_response(400,
                      description="Returned if the tag is assignedd to onr or more item. In this case, the tag is not deleted")
